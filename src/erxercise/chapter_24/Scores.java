...
public class Scores {
    public static void main(String[] args) {
        ...
        //Average
        double sumAClass =  calculateAverage(studentAClass1,studentAClass2,studentAClass3);

        double sumBClass =  calculateAverage(studentBClass1,studentBClass2,studentBClass3);

        System.out.printf("A 학급의 평균 점수는 %.2f, B학급 평균은 %.2f",sumAClass,sumBClass);
