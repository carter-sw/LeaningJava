...
// 가격표
// [가격표] 아메리카노:5천원, 카페라뗴 :6천원,카페모카 :6500원, 카푸치노 :6천원
...
public class Cashier {
    ...
    public Coffee wrapUpCoffeee(Coffee coffee){
        coffee.beWrappedUp();
        return coffee;
    }
    ...
    public void sayCoffeeReady(Coffee coffee){
        ...
        System.out.println("캐시어: 주문하신 커피 "+coffeeName+"가 준비 완료 되었습니다.");
    }
