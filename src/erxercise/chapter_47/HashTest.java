...
public class HashTest {
    ...
    public static void main(String[] args) {
        ...
        long hashCode4 = Objects.hashCode(new VIPCustomer("아이유")); // 고유한 정수값으로 바뀌어서 출력됨.
        ...
        System.out.println("Objects.hashCode 첫번쨰 Customer: "+hashCode5);
        System.out.println("Objects.hashCode 두번쨰 Customer: "+hashCode6);
