...
// 2. 주문 아이템을 만듭니다.
        ...
        orders.add(new Order(1001, customer1, LocalDate.now(), "PAID", orderItems1));
        orders.add(new Order(1002, null,LocalDate.now() , "SHIPPED", orderItems2));
        orders.add(new Order(1003, customer3, LocalDate.now(), "SHIPPED", orderItems2));
        orders.add(new Order(1004, customer2, LocalDate.now(), "ON ORDER", null));
        orders.add(new Order(1005, customer4, LocalDate.now(), "NOT PAID", null));
        orders.add(new Order(1006, customer1, LocalDate.now(), "SHIPPED", orderItems2));
